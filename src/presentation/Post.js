  ...
  return (
    <View style={{flex: 1, width: 100 + "%"}} >
      <View style={styles.userBar}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Image
            ...
            source={{
              uri: 'https://en.bcdn.biz/Images/2018/6/6/ae2e9240-c42a-4a81-b6d8-ac65af25b827.jpg',
            }}
          />
      ...
      <View style={styles.iconBar}>
        <IconAntDesign name={heartIconID} size={30} style={{padding: 5, color: heartIconColor}} />
